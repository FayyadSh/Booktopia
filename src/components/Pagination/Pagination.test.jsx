...
describe("Pagination Component", () => {
  ...
  test("renders correctly when not loading", () => {
    render(<Pagination length={5} dataArray={[]} />);
  ...
  test("renders loading state", () => {
    useGlobalContext.mockReturnValueOnce({ loading: true });
  ...
  test("triggers handlePagination when next button is clicked", () => {
    render(<Pagination length={26} dataArray={[]} />);
  ...
  test("triggers handlePagination when previous button is clicked", () => {
    ...
    render(<Pagination length={5} dataArray={[1, 2, 3, 4, 5]} />);
  ...
  test("updates correctly when totalPages changes dynamically", () => {
    const { rerender } = render(<Pagination length={5} dataArray={[]} />);
    ...
    rerender(<Pagination length={10} dataArray={[]} />);
  ...
  test("disables all buttons if dataArray length is zero and totalPages is 1", () => {
    usePaginate.mockReturnValueOnce({
      ...mockUsePaginate,
      books: [],
      totalPages: 1,
    ...
    render(<Pagination length={0} dataArray={[]} />);
